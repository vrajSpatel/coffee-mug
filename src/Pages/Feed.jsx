            ...
            <div className="container_feed">
                <div className="allsection">
                    ...
                    <div className="nav_menu">
                        ...
                        <ul>
                            <li>
                                <Link to="/feed" className="active"><img src="https://assets.coffeemug.ai/assets/v2/img/svg/home-color.svg" alt="" />Home</Link>
                            </li>
                            <li>
                                <Link to="/jobs"><img src="https://assets.coffeemug.ai/assets/v2/img/svg/careers.svg" alt="" />Jobs <span className="badge">new</span></Link>
                            </li>
                            <li>
                                <Link to="/members"><img src="https://assets.coffeemug.ai/assets/v2/img/svg/member.svg" alt="" />Members</Link>
                            </li>

                            <li>
                                <Link to="/mentors"><img src="https://assets.coffeemug.ai/assets/v2/img/svg/mentorship.svg" alt="" />Mentors</Link>
                            </li>
                            <li>
                                <Link to="/startups"><img src="https://assets.coffeemug.ai/assets/v2/img/svg/invest.svg" alt="" />Startup</Link>
                            </li>
                            <li>
                                <Link to="/startup-investors"><img src="https://assets.coffeemug.ai/assets/v2/img/svg/invest.svg" alt="" />Investor List</Link>
                            </li>

                            <li>
                                <Link to="/my-matches"><img src="https://assets.coffeemug.ai/assets/v2/img/svg/connection.svg" alt="" /> My Connections</Link>
                            </li>

                            <li>
                                <Link to="/inbox"><img src="https://assets.coffeemug.ai/assets/v2/img/svg/chat.svg" alt="" />My Chats</Link>
                            </li>
                        </ul>
                    ...
                    <div className="sidebar">
                        <div className="mentor_area">
                            <h4 className="sidebar_title">Achieve your goals by connecting with right
                                &ensp;
                                <span className="primary-text">Founder</span> &amp; <span className="primary-text">Investor/VC</span>            experts
                            </h4>
                            ...
                            <div className="custom_btn">
                                <Link to="/" className="border_btn">View matching members</Link>
                            </div>
                        </div>
                            ...
                            <ul className="roles_list js-industries-members">
                                ...
                                <li>
                                    <Link to="https://coffeemug.ai/suggested-members/industry/big-data-ai-iot-robotics">
                                        <div className="list">
                                            <h5 className="list_item">Automation/AI/ML/IOT/data tech/robots</h5>
