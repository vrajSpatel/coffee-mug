    ...
    <>
      ...
      <div className="whole_homepage">
        ...
        <div className="banner align-item-center">
          <div className="left_banner">
            <div className="bannerdata">
              ...
              <Link to="/choose-goals" className="banner_btn">Join Now for Free
        ...
        <div className="our_member_section">
          ...
          <div className="container_members">
            ...
            <div className="heading">
              <center><h1>Say Hello to Our Members</h1></center>
            </div>
            ...
            <div className="members_list">
              <Link>
                <div className="perticularmember">
                  <div className="memberimage">
                    <img src='https://assets.coffeemug.ai/li-files/image-0be099c2-a38a-4844-8ef0-7b8af02f7f72.jpg' alt="change cdn" />
                  </div>
              ...
              <Link>
                <div className="perticularmember">
                  <div className="memberimage">
                    <img src="https://assets.coffeemug.ai/li-files/image-3fddd048-c9e6-46b0-aae4-47d0771aa6df.jpg" alt="cdn" />
                  </div>
                  <div className="perticularmemberinfo">
              ...
              <Link>
                <div className="perticularmember">
                  <div className="memberimage">
                    <img src="https://assets.coffeemug.ai/li-files/image-f9dcd00a-3adf-4f03-9e30-e8143ade8f21.jpg" alt="" />
                  </div>
                  <div className="perticularmemberinfo">
                    <h4>Ashih Tulsian</h4>
                    <p>Cheif Enabler</p>
              ...
              <Link>
                <div className="perticularmember">
                  <div className="memberimage">
                    <img src="https://assets.coffeemug.ai/li-files/image-802179a3-ed80-40b1-af75-aff928990393.jpg" alt="" />
                  </div>
                  <div className="perticularmemberinfo">
                    <h4>Umang Bedi</h4>
                    <p>Co-Founder</p>
              ...
              <Link>
                <div className="perticularmember">
                  <div className="memberimage">
                    <img src="https://assets.coffeemug.ai/li-files/image-a3c42887-0959-4d39-95cf-b95d8efc6f0a.jpg" alt="" />
                  </div>
                  <div className="perticularmemberinfo">
                    <h4>Anurakt Jain</h4>
                    <p>CEO</p>
              ...
              <Link>
                <div className="perticularmember">
                  <div className="memberimage">
                    <img src="https://assets.coffeemug.ai/li-files/image-6f9e005a-43b7-4fec-90f0-7cf88f337457.jpg" alt="" />
                  </div>
                  <div className="perticularmemberinfo">
              ...
              <Link>
                <div className="perticularmember">
                  <div className="memberimage">
                    <img src="https://assets.coffeemug.ai/li-files/image-ae848f3c-013c-48b2-a529-aaf503779364.jpg" alt="" />
                  </div>
                  <div className="perticularmemberinfo">
                    <h4>Puneet Gupt</h4>
                    <p>COO</p>
              ...
              <Link>
                <div className="perticularmember">
                  <div className="memberimage">
                    <img src="https://assets.coffeemug.ai/li-files/image-cae3d4f8-377f-47c4-b068-aa0c7b00c26c.jpg" alt="" />
                  </div>
                  <div className="perticularmemberinfo">
                    <h4>Sairee Chahal</h4>
                    <p>Founder</p>
              ...
              <Link>
                <div className="perticularmember">
                  <div className="memberimage">
                    <img src="https://assets.coffeemug.ai/li-files/image-97caf82f-a7ae-4e12-b836-c4c79fe89328.jpg" alt="" />
                  </div>
                  <div className="perticularmemberinfo">
                    <h4>Aloke Bajpai</h4>
                    <p>CEO & Co-Founder</p>
            ...
            <center> <button type="button" className="btn btn-lg">View More Members <i className="fa-solid fa-angle-right" aria-hidden="true"></i> </button> </center>
          </div>
        </div>
        ...
        <div className="leadership_section">
          <div className="contaier_leadership">
            ...
            <div className="upper_card_leadership">
              ...
              <div className="left_leadership">
                <div className="header_left">
                  ...
                  <p>We help in 3x faster leadership hiring through AI based matchmaking and personalised 1:1 introductions.</p>
                </div>
                ...
                <button type="button" className="btn btn-lg">Explore Talent Solution <i className="fa-solid fa-angle-right" aria-hidden="true"></i> </button>
              ...
              <div className="right_leadership">
                <div className="profilecard_right">
                  <div className="imageofcard">
                    <img src="https://assets.coffeemug.ai/assets/web-assets/home-v3/images/leadership_img.png" alt="" />
                  </div>
                  <p>Ramneek Khurana hired engineering and product leaders for Lenskart</p>
                  <Link to='https://coffeemug.ai/talentmug/#ramneek '>Read His Story</Link>
                </div>
              </div>
            ...
            <div className="lower_carousal_leadership">
              ...
              <center><p>Companies Hiring on CoffeeMug</p></center>
        ...
        <div className="why_make_connection">
          ...
          <center><h1>Why make connections through CoffeeMug?</h1></center>
          ...
          <div className="lower-info-connection">
            <div className="left-info-image">
              <img src="https://assets.coffeemug.ai/assets/web-assets/home-v3/images/Group_image.png" alt="" />
            </div>
                ...
                <ul>
                  <li>
                    <span className="why_icon">
                      <img className="img-fluid" src="https://assets.coffeemug.ai/assets/web-assets/home-v3/images/icon1.png" alt="" />
                    </span> Curated Network of Senior Professionals
                  </li>
                  <li>
                    <span className="why_icon">
                      <img className="img-fluid" src="https://assets.coffeemug.ai/assets/web-assets/home-v3/images/icon2.png" alt="" />
                    </span> No Spam messaging allowed
                  </li>
                  <li>
                    <span className="why_icon">
                      <img className="img-fluid" src="https://assets.coffeemug.ai/assets/web-assets/home-v3/images/icon3.png" alt="" />
                    </span> 1:1 Introductions with consent
                  </li>
                </ul>

                <button type="button" className="btn btn-lg">Join For Free Now <i className="fa-solid fa-angle-right" aria-hidden="true"></i> </button>
              </div>
            </div>
          </div>
          ...
          <div className="container_how_it_work">
            <div className="left_info_how-work">
              ...
              <ul>
                <li>
                  <span className="why_icon">
                    <img className="img-fluid" src="https://assets.coffeemug.ai/assets/web-assets/home-v3/images/icon4.png" alt="" />
                  </span> Share Your Professional Goals
                </li>
                <li>
                  <span className="why_icon">
                    <img className="img-fluid" src="https://assets.coffeemug.ai/assets/web-assets/home-v3/images/icon5.png" alt="" />
                  </span> See Matched Members
                </li>
                <li>
                  <span className="why_icon">
                    <img className="img-fluid" src="https://assets.coffeemug.ai/assets/web-assets/home-v3/images/icon6.png" alt="" />
                  </span> Meet With Mutual Consent
                </li>
              </ul>
            ...
            <div className="right_img_how-work">
              <div className="right-img-work">
                <img src="https://assets.coffeemug.ai/assets/web-assets/home-v3/images/work_img.png" alt="" />
              </div>
            </div>
          ...
          <div className="getapp_container">
            <div className="getapp_container_info">
              <div className="leftsideinfo_getapp">
                <h2>Get the App and Start Discovering Professional Connections</h2>

                <div className="app_rating_store">
                  <div className="appstore">
                    <p>User Rating</p>
                    <h4>
                      4.6 <span><i className="fa-solid fa-star" aria-hidden="true"></i></span>
                    </h4>
                    <Link to="https://apps.apple.com/app/id1580344709?mt=8">
                      <img src="https://assets.coffeemug.ai/assets/web-assets/home-v3/images/ios-store-icon.png" alt='' className="img-fluid" />
                    </Link>
                  </div>
                  <div className="appstore">
                    <p>User Rating</p>
                    <h4>
                      4.4 <span><i className="fa-solid fa-star" aria-hidden="true"></i></span>
                    </h4>
                    <Link href="https://play.google.com/store/apps/details?id=com.app.coffeemug&amp;referrer=utm_source%3Dcoffeemug%26utm_medium%3Dcoffeemug%26utm_term%3Dcm%252Bpromotion%26utm_campaign%3DCM%2520Promotion">
                      <img src="https://assets.coffeemug.ai/assets/web-assets/home-v3/images/google-play-icon.png" alt='' className="img-fluid" /></Link>
                  </div>
                </div>

              </div>
              <div className="rightsideimage_getapp">
                <img src="https://assets.coffeemug.ai/assets/web-assets/home-v3/images/app-store-img.png" alt="" />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="accordion" id="accordionExample">
              ...
              <div className="accordion-item">
                ...
                <div id="collapseOne" className="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                  <div className="accordion-body">
                    <p>On most professional networks, you need to identify, reach out, and set
                      the context with a hope to hear back from them, which let's face it,
                      happens rarely.</p>

                    <p>
                      At CoffeeMug, we do the heavy lifting of connecting you with a relevant
                      member based on your long term goals and short term needs. Since we are
                      a warm introduction platform, when we connect our members with a
                      context, the response rate is high.
                    </p>

                    <p>Also, the fact that we are curated assures you of interaction with other
              ...
              <div className="accordion-item">
                ...
                <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                  <div className="accordion-body">
                    <p>As of now, the CoffeeMug Beta is free for members. There are no charges
                      for using CoffeeMug currently.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="accordion-item">
                ...
                <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                  <div className="accordion-body">
                    <p>
                      Think of us like a Super Sharp Concierge Service, which will help you
                      fill your long term goals and immediate needs about your professional
                      space. We connect you with the right people to meet your objectives
                      including:
                    </p>
                    ...
                    <ul>
                      ...
                      <li>Connect with lateral thinkers from diverse professions</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="accordion-item">
                ...
                <div id="collapseFour" className="accordion-collapse collapse " aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                  <div className="accordion-body">
                    <p>
                      We will introduce you to a relevant member every week, so you can
                      interact over a video call. Our AI algorithm figures out the most
                      relevant member to make introductions with every week.
                    </p>
                    <p>
                      Our members do half the work in sharing more about their professional
                      goals and the current set of needs. The remaining work is done by the
                      match-making algorithm, which keeps improving with time with inputs from
                      our teams
                    </p>
                  </div>
                </div>
              ...
              <div className="accordion-item">
                ...
                <div id="collapseFive" className="accordion-collapse collapse " aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                  <div className="accordion-body">
                    <p>
                      We cannot guarantee that you will be matched with the connections for
                      your choice. However, our AI-based algorithm surely takes this into
                      consideration while curating introductions for you.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="accordion-item">
                ...
                <div id="collapseSix" className="accordion-collapse collapse " aria-labelledby="headingSix" data-bs-parent="#accordionExample">
                  <div className="accordion-body">
                    <p>Once a week, we send you an email introducing your match so that you can
                      take the conversation ahead and set up the meeting.</p>
                    <p>Our email and chat -based messaging system keeps your contact details
                      private. You may choose to share your contact details with your
                      connection to take the conversation forward.</p>
                  </div>
                </div>
              </div>
